 ...
 * friendly way of contacting a chat room server. The basic outline of the GUI
 * includes a chat area where the user can send messages. A server area where
 * the user receives information from the server and a send button that allows
 * the user to send information with a button press instead of the enter key.
 * The client works on the backend by waiting for server input from a thread
 * while waiting for user input in another.
 *
 * @author James Sharpe
 */
    ...
    public JWSClient() throws Exception
    {
        ...
        clientChat.addKeyListener(new KeyAdapter()
        {
            ...
            public void keyPressed(KeyEvent e)
            {
                 ...
                 * because the keyTyped method does not register the
                 * "VK_ENTER" key stroke.
                 */
